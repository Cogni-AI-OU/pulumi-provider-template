...
class Random(pulumi.CustomResource):
    ...
    @overload
    def __init__(__self__, resource_name: str, args: RandomArgs, opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a Random resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
    ...
    def _internal_init(
        ...
        super(Random, __self__).__init__("provider-boilerplate:index:Random", resource_name, __props__, opts)

    @staticmethod
    def get(resource_name: str, id: pulumi.Input[str], opts: Optional[pulumi.ResourceOptions] = None) -> "Random":
        """
