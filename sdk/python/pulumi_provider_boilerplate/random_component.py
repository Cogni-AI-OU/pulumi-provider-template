...
class RandomComponent(pulumi.ComponentResource):
    ...
    @overload
    def __init__(
        __self__, resource_name: str, args: RandomComponentArgs, opts: Optional[pulumi.ResourceOptions] = None
    ):
        """
        Create a RandomComponent resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
    ...
    def _internal_init(
        ...
        super(RandomComponent, __self__).__init__(
            "provider-boilerplate:index:RandomComponent", resource_name, __props__, opts, remote=True
        )
