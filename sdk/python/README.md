# Pulumi Provider SDK for Python

This repository is a boilerplate showing how to create and locally test a native Pulumi provider (with examples of
both CustomResource and ComponentResource [resource types](https://www.pulumi.com/docs/iac/concepts/resources/)).
...
* [NodeJS](https://nodejs.org/en/) 14.x. We recommend using [nvm](https://github.com/nvm-sh/nvm) to manage NodeJS
  installations.
* [Yarn](https://yarnpkg.com/)
* [TypeScript](https://www.typescriptlang.org/)
* [Python](https://www.python.org/downloads/) (called as `python3`). For recent versions of MacOS, the system-installed
  version is fine.
...
1. Run `make gen_examples` to generate the example programs in `examples/` off of the source `examples/yaml` example
   program.
...
Pulumi offers this repository as a [GitHub template repository][template] for convenience. From this
repository:
...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub
   ...
   - replace all instances of the `github.com/pulumi/pulumi-provider-boilerplate` repository with the `REPOSITORY`
     location
...
2. `Makefile` - targets to help with building and publishing the provider. Run `make ci-mgmt` to regenerate CI
   workflows.
